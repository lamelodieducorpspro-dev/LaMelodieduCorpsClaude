/**
 * Données FAQ partagées entre le composant FAQ.jsx (client)
 * et app/faq/page.js (server) pour le schéma JSON-LD.
 */
export const faqCategories = [
  {
    ...
    items: [
      {
        q: "Peut-on guérir le SMOP par l'alimentation ?",
        a: "L'alimentation ne guérit pas le SMOP, mais elle peut considérablement améliorer les symptômes en soutenant l'équilibre hormonal, en stabilisant la glycémie et en réduisant l'inflammation. Beaucoup de femmes constatent une amélioration sur la fatigue, les fringales et la régularité du cycle.",
      },
      {
      ...
      {
        q: "Quels aliments éviter avec le SMOP ?",
