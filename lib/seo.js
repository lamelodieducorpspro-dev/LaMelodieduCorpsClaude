...
export const OG_IMAGE = `${SITE_BASE_URL}/images/og-banner-melodie-du-corps.webp`;
 ...
 * Pass absoluteTitle: true to bypass the layout's title template (e.g. homepage).
 */
...
export const localBusinessJsonLd = {
  ...
  description:
    "Praticienne en nutrition holistique et professeure de yoga à Bouillante, Guadeloupe. Accompagnement de la santé hormonale féminine (SMOP, endométriose, ménopause).",
  url: SITE_BASE_URL,
